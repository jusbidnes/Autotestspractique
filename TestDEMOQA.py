...
def test_text_box_form(page):
    ...
    """
    page.goto(TEXT_BOX_URL, wait_until="domcontentloaded")
...
def test_check_box(page):
    ...
    """
    page.goto(CHECK_BOX_URL, wait_until="domcontentloaded")
...
def test_radio_button(page):
    ...
    """
    page.goto(RADIO_BUTTON_URL, wait_until="domcontentloaded")
...
def test_web_tables(page):
    ...
    page.goto(WEB_TABLES_URL, wait_until="domcontentloaded")
...
def test_buttons(page):
    ...
    """
    page.goto(BUTTONS_URL, wait_until="domcontentloaded")
...
def test_dynamic_properties(page):
    ...
    """
    page.goto(DYNAMIC_PROPERTIES_URL, wait_until="domcontentloaded")
...
def test_upload_and_download(page):
    ...
    page.goto(UPLOAD_DOWNLOAD_URL, wait_until="domcontentloaded")
...
def test_modal_dialogs(page):
    ...
    page.goto(MODAL_DIALOGS_URL, wait_until="domcontentloaded")
